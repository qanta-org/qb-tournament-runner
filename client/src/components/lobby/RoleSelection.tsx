    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Quiz Bowl Buzzer</h1>
          <p className="text-blue-200">Human-AI Hybrid Competition System</p>
          {!isConnected && (
          ...
          {mode === 'select' ? (
            <div className="p-8">
              ...
              <button
                ...
                className="w-full mb-4 p-6 rounded-xl border-2 border-blue-500 bg-blue-50 hover:bg-blue-100 transition-colors text-left disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <div className="flex items-center gap-4">
                  <div className="text-4xl">🎙️</div>
                  <div>
                    <h3 className="text-lg font-semibold text-blue-800">Start as Moderator</h3>
              ...
              <button
                ...
                disabled={!isConnected}
                className="w-full p-6 rounded-xl border-2 border-green-500 bg-green-50 hover:bg-green-100 transition-colors text-left disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <div className="flex items-center gap-4">
